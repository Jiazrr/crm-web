      ...
      >
        ...
        <el-form-item label="客户等级" prop="level">
          <el-select v-model="dialogProps.row!.level" filterable placeholder="请选择客户等级">
            <el-option v-for="item in Object.values(CustomerLevelList)" :key="item.label" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="客户来源" prop="source">
          <el-select v-model="dialogProps.row!.source" filterable placeholder="请选择客户来源">
            <el-option v-for="item in Object.values(CustomerSourceList)" :key="item.label" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="跟进状态" prop="followStatus">
          <el-select v-model="dialogProps.row!.followStatus" filterable placeholder="请选择客户跟进状态">
            <el-option v-for="item in Object.values(FollowUpStatusList)" :key="item.label" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="是否为关键决策人" prop="isKeyDecisionMaker">
          <el-select v-model="dialogProps.row!.isKeyDecisionMaker" filterable placeholder="请选择客户是否为关键决策人">
            <el-option v-for="item in Object.values(IsKeyDecisionMakerList)" :key="item.label" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="客户性别" prop="gender">
          <el-select v-model="dialogProps.row!.gender" filterable placeholder="请选择性别">
            <el-option v-for="item in Object.values(GenderList)" :key="item.label" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
    </div>
